...
import carImage from '../../../node_modules/react-native-maps/example/examples/assets/car.png'
      ...
      <View style={styles.flex}>
        ...
        <View style={styles.buttonContainerUpDown}>
          <TouchableOpacity
            ...
            onPress={() => this.changePosition(0.001, 0)}
          >
            <Text>+ Lat</Text>
          </TouchableOpacity>
          <TouchableOpacity
        ...
        <View style={styles.buttonContainerLeftRight}>
          <TouchableOpacity
            ...
            onPress={() => this.changePosition(0, -0.001)}
          >
            <Text>- Lon</Text>
          </TouchableOpacity>
          <TouchableOpacity
